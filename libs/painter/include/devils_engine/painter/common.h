...
#define DEVILS_ENGINE_PAINTER_FORMAT_NAME_LIST \
  X(v4, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R32G32B32A32_SFLOAT) \
  X(p4, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R32G32B32A32_SFLOAT) \
  X(n4, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R32G32B32A32_SFLOAT) \
  X(uv4, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R32G32B32A32_SFLOAT) \
  X(ui4, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R32G32B32A32_UINT) \
  X(i4, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R32G32B32A32_SINT) \
  X(sf4, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R16G16B16A16_SFLOAT) \
  X(bf4, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R8G8B8A8_SRGB) \
  X(c4, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R8G8B8A8_UNORM) \
  X(srgba8, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R8G8B8A8_SRGB) \
  X(rgba8, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R8G8B8A8_UNORM) \
  X(rgba16, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R16G16B16A16_UNORM) \
  X(rgba32, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R32G32B32A32_SFLOAT) \
  X(v3, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R32G32B32_SFLOAT) \
  X(p3, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R32G32B32_SFLOAT) \
  X(n3, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R32G32B32_SFLOAT) \
  X(uv3, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R32G32B32_SFLOAT) \
  X(ui3, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R32G32B32_UINT) \
  X(i3, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R32G32B32_SINT) \
  X(sf3, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R16G16B16_SFLOAT) \
  X(bf3, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R8G8B8_SRGB) \
  X(c3, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R8G8B8_UNORM) \
  X(rgb8, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R8G8B8_UNORM) \
  X(rgb16, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R16G16B16_UNORM) \
  X(rgb32, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R32G32_SFLOAT) \
  X(v2, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R32G32_SFLOAT) \
  X(p2, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R32G32_SFLOAT) \
  X(n2, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R32G32_SFLOAT) \
  X(uv2, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R32G32_SFLOAT) \
  X(ui2, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R32G32_UINT) \
  X(i2, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R32G32_SINT) \
  X(sf2, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R16G16_SFLOAT) \
  X(bf2, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R8G8_SRGB) \
  X(c2, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R8G8_UNORM) \
  X(rg8, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R8G8_UNORM)  \
  X(rg16, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R16G16_UNORM) \
  X(rg32, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R32G32_SFLOAT) \
  X(v1, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R32_SFLOAT) \
  X(p1, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R32_SFLOAT) \
  X(n1, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R32_SFLOAT) \
  X(uv1, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R32_SFLOAT) \
  X(ui1, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R32_UINT) \
  X(i1, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R32_SINT) \
  X(sf1, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R16_SFLOAT) \
  X(bf1, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R8_SRGB) \
  X(c1, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R8_UNORM) \
  X(r8, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R8_UNORM) \
  X(r16, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R16_UNORM) \
  X(r32, VK_IMAGE_ASPECT_COLOR_BIT, VK_FORMAT_R32_SFLOAT) \
  X(d32, VK_IMAGE_ASPECT_DEPTH_BIT, VK_FORMAT_D32_SFLOAT) \
  X(d16, VK_IMAGE_ASPECT_DEPTH_BIT, VK_FORMAT_D16_UNORM) \
  X(ds32, VK_IMAGE_ASPECT_DEPTH_BIT | VK_IMAGE_ASPECT_STENCIL_BIT, VK_FORMAT_D32_SFLOAT_S8_UINT) \
  X(ds24, VK_IMAGE_ASPECT_DEPTH_BIT | VK_IMAGE_ASPECT_STENCIL_BIT, VK_FORMAT_D24_UNORM_S8_UINT) \
  X(ds16, VK_IMAGE_ASPECT_DEPTH_BIT | VK_IMAGE_ASPECT_STENCIL_BIT, VK_FORMAT_D16_UNORM_S8_UINT) \
  X(dispatch3, 0, VK_FORMAT_UNDEFINED) \
  X(draw4, 0, VK_FORMAT_UNDEFINED) \
  X(indexed5, 0, VK_FORMAT_UNDEFINED) \
  X(swapchain4, 0, VK_FORMAT_UNDEFINED) \
