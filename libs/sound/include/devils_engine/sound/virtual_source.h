...
/*
  короче virtual_source это плохая идея
  самый нормальный способ это отправлять события через отдельную систему
  где мы просто перечислим настройки нас интересующие
  + способ передать пачкой все трансформы
*/
