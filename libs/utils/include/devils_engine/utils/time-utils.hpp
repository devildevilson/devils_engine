...
constexpr const char* const ISO_date_format = "%F";
constexpr const char* const ISO_time_format = "%T";
constexpr const char* const ISO_offset_from_utc = "%z";
constexpr const char* const ISO_datetime_format = "%F %T";
constexpr const char* const ISO_datetime_filename_valid_format = "%F_%H-%M-%S";
constexpr const char* const ISO_full_datetime_format = "%F %T %z";
