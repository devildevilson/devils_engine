#ifndef DEVILS_ENGINE_SIMUL_DRAW_INTENT_H
#define DEVILS_ENGINE_SIMUL_DRAW_INTENT_H
...
// Главная сторона контракта producer -> render: типизированный упаковщик инстансов в СЫРЫЕ БАЙТЫ.
...
public:
  ...
  // упаковать инстансы в буфер вызывающего (напр. payload сообщения producer->render).
