#ifndef DEVILS_ENGINE_SIMUL_INSTANCE_LAYOUT_H
#define DEVILS_ENGINE_SIMUL_INSTANCE_LAYOUT_H
...
// draw_group), поэтому конкретные структуры остаются только на стороне потребителя, а матчер
