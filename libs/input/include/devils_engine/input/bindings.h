...
// (в файле: `camera_up = [key_w, up]`), проект кладёт её секцией в свою settings-схему; движок
// накатывает её ПОВЕРХ дефолтного словаря (bind_default_actions) при создании окна/reload и
// выгружает эффективную живую карту обратно перед save (см. simul/main_runtime.h).
//
