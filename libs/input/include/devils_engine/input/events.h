...
std::string_view to_string(values v);
} // namespace default_events
...
public:
  ...
  static constexpr int32_t mouse_button_scancode(const int32_t button) noexcept {
    return mouse_button_scancode_base + button;
  }
