...
Активная площадка — `PF08_weather_effects`: независимый clear baseline и первый weather-state с
аэрозолем/общим ветром закрыты (`52/52` headless-проверки); дальше идут froxel-объём и экранные проявления
погоды, не меняя закрытый PF07.
