...
| 2 | `GN02_planet_generator` *(active)* | планета целиком: плиты, суша, области рельефа, климат, сезоны, провинции, морские зоны, культуры, история, иерархия названных мест и титулов, пакет на диск | planetary strategy / `PF10` |
...
[`GN02_planet_generator`](subprojects/playgrounds/GN02_planet_generator/README.md) **АКТИВНАЯ,
первый вертикальный срез закрыт 2026-08-31**: планета считается целиком от тектоники вниз по причинам.
...
Следующая площадка кампании не выбрана заранее. Ближайшие кандидаты — потоковая пещерная генерация
для `submarine_coop` (граф маршрутов грубым проходом, кишка чанковым) и чтение пакета GN02 площадкой
