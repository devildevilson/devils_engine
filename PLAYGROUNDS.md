...
и конечный облачный слой в `160x90x96` froxel-сетке закрыты. Объём получает обе звезды, луны и их каскадные
...
PF08 против сохранённых PNG PF07, поэтому закрытая площадка больше не переснимается. Дальше идут осадки,
не меняя закрытый PF07.
