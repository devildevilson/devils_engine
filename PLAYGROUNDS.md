...
Активная площадка — `PF08_weather_effects`: она начинает с независимой копии этого baseline и добавляет
погодное состояние, froxel-объём и экранные проявления погоды, не меняя закрытый PF07.
