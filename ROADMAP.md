...
- ✅ **image Стадия 1** (`visage::image` + `nk.image` + `nk.placement` + host `app.image`; рендер уже был готов). ⏳ Стадия 2: стенсил-эффекты (cooldown/4-blend через маск-текстуру) + demiurg-ресурс как источник картинки вместо host-моста.
