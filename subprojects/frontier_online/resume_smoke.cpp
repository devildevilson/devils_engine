// Resume-детерминизм РЕАЛЬНОГО геймплея frontier_online: прогоняем симуляцию, checkpoint → restore в
...
namespace tf = frontier_online::core;
...
int main() {
  ...
  test_brain_fixture fixture(FRONTIER_ONLINE_SOURCE_RESOURCE_ROOT);
