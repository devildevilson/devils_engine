#ifndef FRONTIER_ONLINE_CORE_SIMULATION_H
#define FRONTIER_ONLINE_CORE_SIMULATION_H
...
// а вся проектная сцена/actor pipeline/render+sound publication/metrics свёрнута в frontier_online_game.
//
