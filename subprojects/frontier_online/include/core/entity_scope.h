#ifndef FRONTIER_ONLINE_CORE_ENTITY_SCOPE_H
#define FRONTIER_ONLINE_CORE_ENTITY_SCOPE_H
...
// Root-скоуп геймплейных скриптов devils_script для frontier_online. Пара {world, entityid} по
