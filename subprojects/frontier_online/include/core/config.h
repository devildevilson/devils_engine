#ifndef FRONTIER_ONLINE_CORE_CONFIG_H
#define FRONTIER_ONLINE_CORE_CONFIG_H
...
struct simulation_config {
  ...
  // Ассетный поток является частью топологии runtime. frontier_online требует его для обычного
