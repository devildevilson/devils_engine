...
-- Панель намеренно диагностическая: authored weather выбирается T/CLI, а независимые значения выводятся
-- рядом. Интерактивные слайдеры не должны стать вторым источником истины поверх weather transition.
...
return function()
  ...
  if nk.begin_titled("pf08_diagnostics", playground_title or "PF08", {16, 16, 520, diagnostic_height}, diagnostic_flags) then
    nk.push_font(14)
