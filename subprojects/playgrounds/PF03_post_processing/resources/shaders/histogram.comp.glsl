...
// Локальная гистограмма в разделяемой памяти. Атомарные сложения прямо в глобальный буфер означали бы по
// атомику на пиксель на всю рабочую группу — здесь их 64 на группу вместо 64 пикселей × конкуренция.
