...
// Алгоритм: построение карты circle of confusion для физической тонкой линзы. Reverse-Z глубина переводится
// в метры, после чего фокусное расстояние, диафрагма, дистанция фокусировки и размер сенсора дают диаметр
// пятна уже в пикселях дисплея. Знак отличает передний план от заднего, .g хранит линейную глубину, а небо
// считается через аналитический предел D -> infinity вместо деления на нулевую reverse-Z глубину.
