...
// Общая часть color-grading алгоритма. Линейный HDR проходит chromatic adaptation Bradford к D65, цветной
// фильтр, log-domain contrast, ASC CDL и saturation в фиксированном порядке. Те же функции умеют кодировать
// диапазон shaper'ом и выбирать 3D LUT с полутексельной поправкой; поэтому аналитический и табличный пути
// различаются только ошибкой табулирования, которую можно показать отдельным debug view.
