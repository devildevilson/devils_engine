...
// Алгоритм: обратный проход bloom-пирамиды. Более грубый уровень поднимается 3x3 tent-фильтром, чтобы
// скрыть квадраты низкого разрешения, умножается на вес распространения и прибавляется к уже существующему
// более точному уровню. Сложение идёт на месте в general-layout: каждый уровень накапливает свечение всех
// более широких масштабов, а отдельный ping-pong образ не нужен.
