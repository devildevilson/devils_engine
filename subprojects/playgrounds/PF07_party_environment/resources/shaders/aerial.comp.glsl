...
// восьмишаговый марш на пиксель одной выборкой. Настоящий смысл появится в срезах 4-5, когда в кадре
// будут рельеф и заросли: таблица уже готова их принять, потому что ничего не знает про источник
// глубины и работает с любой.
//
