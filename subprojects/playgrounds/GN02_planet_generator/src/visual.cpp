...
// Палитра видов областей рельефа. Порядок совпадает с идентификаторами из scripts/landform_water.ds
// и scripts/landform_land.ds и с таблицей имён в main.cpp.
//
